...
hoistedDependencies:
  ...
  word-wrap@1.2.5:
    word-wrap: private
  wrappers/api-client:
    '@rq/api-client': private
  wrappers/design-system:
    '@rq/design-system': private
  wrappers/evaluator:
    '@rq/evaluator': private
  wrappers/events:
    '@rq/events': private
  yocto-queue@0.1.0:
    yocto-queue: private
...
pendingBuilds: []
prunedAt: Sun, 24 Aug 2025 03:11:25 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-ia32-msvc@4.48.0'
  - '@rollup/rollup-win32-x64-msvc@4.48.0'
storeDir: /Users/alexsteinleitner/Library/pnpm/store/v3
